                                ...
                                <div class="right">
                                    <div class="right-content">
                                        <div class="image-holder">
                                            <img class="seq__1" src="<?= get_template_directory_uri() ?>/images/feature1-10dlctollfree-1.svg" alt="video-sequence">
                                            <img class="seq__2" src="<?= get_template_directory_uri() ?>/images/feature2-realnumbers-1.svg" alt="video-sequence">
                                            <img class="seq__3" src="<?= get_template_directory_uri() ?>/images/feature3-highthroughput.svg" alt="video-sequence">
                                        </div>
